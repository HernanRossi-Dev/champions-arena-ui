      ...
      <div className={cssStyles.homeBodyText}>
        Welcome to the Arena<br />
          <div className={cssStyles.homeTextParagraph}>
            This is very much a work in progress and currently only supports desktop browsers, best with Chrome.<br/> I am constantly updating and implementing new features. Currently there is just a <br/>
