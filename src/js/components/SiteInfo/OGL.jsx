	...
	render() {
		return (
			...
			<div style={{marginLeft: '30%'}}>OPEN GAME LICENSE Version 1.0a<br/><br/>
				...
				6. Notice of License Copyright: You must update the COPYRIGHT NOTICE portion of this License to include the exact text of the COPYRIGHT NOTICE of any Open Game Content You are copying, modifying or distributing, and You must add the title, the copyright date, and the copyright holder's name to the COPYRIGHT NOTICE of any original Open Game Content you Distribute.<br/><br/>
				...
				15. COPYRIGHT NOTICE
				Open Game License v 1.0 Copyright 2000, Wizards of the Coast, Inc.<br/></div>
